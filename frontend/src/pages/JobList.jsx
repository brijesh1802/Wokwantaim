...
// const JobList = () => {
//   const { handleJobRoleChange, currentJobRole, jobs,selectedRadio,checkedOptions,setSelectedRadio,setCheckedOptions} = useContext(AuthContext);
//   const navigate = useNavigate();
...
//         const matchIndustry =
//           !currentJobRole.Industry.length || currentJobRole.Industry.includes(job.industry);

//         const matchJobRole =
//           !currentJobRole.JobRoles.length ||
//           currentJobRole.JobRoles.some((role) => job.title.toLowerCase().includes(role.toLowerCase()));

//         const matchSalary =
//           !currentJobRole.Salary.length ||
//           currentJobRole.Salary.some((range) => {
//             if (range === "₹10,000 - ₹20,000") return job.salary >= 10000 && job.salary < 20000;
//             if (range === "₹20,000 - ₹30,000") return job.salary >= 20000 && job.salary < 30000;
//             if (range === "₹30,000 - ₹50,000") return job.salary >= 30000 && job.salary <= 50000;
//             if (range === "Above ₹50,000") return job.salary > 20000;
//             return false;
//           });
...
//           !currentJobRole.Experience.length ||
//           currentJobRole.Experience.some((range) => {
//             if (range === "0-2 years") return job.experienceYearsMin >= 0 && job.experienceYearsMax <= 2;
//             if (range === "3-5 years") return job.experienceYearsMin >= 2 && job.experienceYearsMax <= 5;
//             if (range === "5+ years") return job.experienceYearsMax >= 5;
//             return false;
//           });

//         return (
//           matchDate && matchIndustry && matchJobRole && matchSalary && matchExperience && matchTitleAndCompany
//         );
//       })
//     );
//   }, [currentJobRole, jobs]);
