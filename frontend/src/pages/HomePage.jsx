...
//               />
//               <button className="flex items-center max-w-xs px-4 py-2 m-1 text-white transition-colors bg-orange-500 rounded-md hover:bg-orange-600 sm:max-w-none">
...
//                 <p className="mb-2 text-gray-600">{category.count} jobs available</p>
...
//           <Link to="/signup" className="inline-flex items-center px-8 py-3 text-lg font-semibold text-white transition-colors bg-orange-500 rounded-md hover:bg-orange-600">
//             Get Started
